			...
			if err = rows.ScanMap(&vv); err != nil {
				...
				for _, o := range types {
					if colValue, ok := vv[o.Name()]; ok && colValue != nil {
						...
						case "BOOL", "TINYINT":
							vi[o.Name()] = tools.ToInt[int8](newValue)
						case "BLOB":
							vi[o.Name()] = colValue
						case "FLOAT":
							vi[o.Name()] = tools.ToFloat[float32](newValue)
						case "DOUBLE", "REAL":
							vi[o.Name()] = tools.ToFloat[float64](newValue)
						case "BIGINT":
							vi[o.Name()] = tools.ToInt[int64](newValue)
						case "INT", "INTEGER":
							vi[o.Name()] = tools.ToInt[int](newValue)
						default:
